...
export default function MetricCard({ title, value, format = "number", change, invertChange = false, subtitle }) {
  ...
  return (
    <div className="bg-surface rounded-2xl border border-border p-5 hover:shadow-[0_4px_24px_var(--hover-glow,rgba(43,124,233,0.08))] hover:border-blue/20 transition-all duration-300 group">
