...
/**
 * Fetch Microsoft/Bing Ads data via GA4.
 * Filters by source containing "bing" or "microsoft".
 */
export async function fetchMicrosoftAdsData(accessToken, { startDate, endDate }) {
  ...
  const bingFilter = {
    orGroup: {
      expressions: [
        { filter: { fieldName: "sessionSource", stringFilter: { matchType: "CONTAINS", value: "bing", caseSensitive: false } } },
        { filter: { fieldName: "sessionSource", stringFilter: { matchType: "CONTAINS", value: "microsoft", caseSensitive: false } } },
      ],
    },
  };
